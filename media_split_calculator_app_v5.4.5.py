# -*- coding: utf-8 -*-
# Media Split Calculator — v5.4.5 (see chat for changelog)
...
# ---- App ----
st.set_page_config(page_title='📊 Media Split Calculator v5.4.5', layout='wide')
st.title('📊 Media Split Calculator — v5.4.5')
...
if st.session_state.mode != 'edit':
    ...
    for i, cat in enumerate(cats):
        key = 'cat_'+cat.replace(' ','_'); prefix = f"{ord_show.get(cat,'□")}  "
