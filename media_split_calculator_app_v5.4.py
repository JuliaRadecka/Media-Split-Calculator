# -*- coding: utf-8 -*-
# Media Split Calculator — v5.7 (routing, stable __id, UI tweaks, exports)
# Changes vs v5.6:
...
# • Start screen: "✏️ Upload a file (.xlsx)" jumps to edit without calc; no warnings until user interacts.
...
st.set_page_config(page_title='📊 Media Split Calculator v5.7', layout='wide')
st.title('📊 Media Split Calculator — v5.7')
...
# Controls header (always visible at top)
