...
def _describe_goal_profile(selected_groups):
    ...
    if not selected_groups:
        return "🎯 Цели сплита: пока категории не выбраны — профиль целей будет смешанным по всему каталогу."
    ...
    if share_aw >= 0.6:
        return "🎯 Цели сплита: выбранные категории в большей степени про охват и узнаваемость (Awareness)."
    if share_conv >= 0.6:
        return "🎯 Цели сплита: выбранные категории в большей степени про перформанс и конверсии (Conversion)."
    return "🎯 Цели сплита: выбранные категории формируют сбалансированный профиль между Awareness и Conversion."
