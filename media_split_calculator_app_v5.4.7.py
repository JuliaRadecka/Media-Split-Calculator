...
# -*- coding: utf-8 -*-
# Media Split Calculator — v5.4.7
# Change: robust fix for sporadic "'float' object has no attribute 'fillna'"
# - Safer apply_category_priorities_from_order (no Series-as-value; no scalar mishaps)
# - Safer budget sum after upload (never treats a scalar as Series)
# - Keeps all features from v5.4.6
...
# ---- App ----
st.set_page_config(page_title='📊 Media Split Calculator v5.4.7', layout='wide')
st.title('📊 Media Split Calculator — v5.4.7')
